...
def section_identification(tokenized, document):
    sections = {}
    sections_list = []
    sections_index = {}
    previous_section = None

    resume_info = extract_resume_info(document)
